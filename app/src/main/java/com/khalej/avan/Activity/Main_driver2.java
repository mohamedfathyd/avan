...
public class Main_driver2 extends AppCompatActivity {
    TabLayout MyTabs;
    ViewPager MyPage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("");
        name.setText("تسليم طلبات للعملاء");
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edt.apply();
                startActivity(new Intent(Main_driver2.this, Login.class));
                finish();
            }
        });
    ...
    public void SetUpViewPager (ViewPager viewpage){
        ...
        Adapter.AddFragmentPage(new BlankFragment4(),"لم يتم توصيلها");
        Adapter.AddFragmentPage(new BlankFragment3(), "تم توصيلها");
